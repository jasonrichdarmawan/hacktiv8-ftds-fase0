...
def main():
    ...
    PrintLine()
    # [value] List is a collection which is ordered and changeable. Allows duplicate members.
    # (value) Tuple is a collection which is ordered and unchangeable. Allows duplicate members.
    # {value} Set is a collection which is unordered, unchangeable*, and unindexed. No duplicate members.
    # {key:value} Dictionary is a collection which is ordered** and changeable. No duplicate members.
    set = {"a", "b"}
    set.add("c")
    Print(set)
